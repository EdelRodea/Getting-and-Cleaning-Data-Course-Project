...
The main tools that I used for this purpose were: functions rbind(), cbind(), the extensive use of regular expressions via grepl(), and functions of the library plyr.
